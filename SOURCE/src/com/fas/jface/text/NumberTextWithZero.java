...
public class NumberTextWithZero extends BaseInputText {
	 ...
	 * @param name
	 */
	public NumberTextWithZero(String name) {
		this(name, 20);
		setHorizontalAlignment(JTextField.RIGHT);
	}
	 ...
	 * @param columns
	 */
	public NumberTextWithZero(String name, int columns) {
		this(name, columns, 0);
		setHorizontalAlignment(JTextField.RIGHT);
	}
	 ...
	 * @param maxlength
	 */
	public NumberTextWithZero(String name, int columns, int maxlength) {
