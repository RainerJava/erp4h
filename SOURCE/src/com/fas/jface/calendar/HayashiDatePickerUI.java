 ...
 */
public class HayashiDatePickerUI extends DatePickerUI {

    @SuppressWarnings("all")
    private static final Logger LOG = Logger.getLogger(HayashiDatePickerUI.class
            .getName());
    ...
    public static ComponentUI createUI(JComponent c) {
        return new HayashiDatePickerUI();
    }
...
//                if (!(formatter instanceof DatePickerFormatterUIResource))  {
    ...
    protected void installKeyboardActions() {
        ...
        pickerMap.put(JXDatePicker.NEXTMONTH_NAVIGATE_KEY, createNextMonthAction());
        pickerMap.put(JXDatePicker.PREMONTH_NAVIGATE_KEY, createPreMonthAction());
        pickerMap.put(JXDatePicker.FIRSTDATE_NAVIGATE_KEY, createFirstDateAction());
        pickerMap.put(JXDatePicker.ENDDATE_NAVIGATE_KEY, createEndDateAction());
        ...
        pickerInputMap.put(KeyStroke.getKeyStroke("shift INSERT"), JXDatePicker.HOME_COMMIT_KEY);
        pickerInputMap.put(KeyStroke.getKeyStroke("INSERT"), JXDatePicker.HOME_NAVIGATE_KEY);
        pickerInputMap.put(KeyStroke.getKeyStroke("PAGE_DOWN"), JXDatePicker.NEXTMONTH_NAVIGATE_KEY);
        pickerInputMap.put(KeyStroke.getKeyStroke("PAGE_UP"), JXDatePicker.PREMONTH_NAVIGATE_KEY);
        pickerInputMap.put(KeyStroke.getKeyStroke("HOME"), JXDatePicker.FIRSTDATE_NAVIGATE_KEY);
        pickerInputMap.put(KeyStroke.getKeyStroke("END"), JXDatePicker.ENDDATE_NAVIGATE_KEY);
    ...
    protected void installLinkPanelKeyboardActions() {
        ...
        map.put(JXDatePicker.PREMONTH_NAVIGATE_KEY, datePicker.getActionMap().get(JXDatePicker.PREMONTH_NAVIGATE_KEY));
        map.put(JXDatePicker.NEXTMONTH_NAVIGATE_KEY, datePicker.getActionMap().get(JXDatePicker.NEXTMONTH_NAVIGATE_KEY));
        map.put(JXDatePicker.FIRSTDATE_NAVIGATE_KEY, datePicker.getActionMap().get(JXDatePicker.FIRSTDATE_NAVIGATE_KEY));
        map.put(JXDatePicker.ENDDATE_NAVIGATE_KEY, datePicker.getActionMap().get(JXDatePicker.ENDDATE_NAVIGATE_KEY));
        InputMap inputMap = datePicker.getLinkPanel().getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW);
        // PENDING: get from LF
        inputMap.put(KeyStroke.getKeyStroke("shift INSERT"), JXDatePicker.HOME_COMMIT_KEY);
        inputMap.put(KeyStroke.getKeyStroke("INSERT"), JXDatePicker.HOME_NAVIGATE_KEY);
        inputMap.put(KeyStroke.getKeyStroke("HOME"), JXDatePicker.FIRSTDATE_NAVIGATE_KEY);
        inputMap.put(KeyStroke.getKeyStroke("END"), JXDatePicker.ENDDATE_NAVIGATE_KEY);
        inputMap.put(KeyStroke.getKeyStroke("PAGE_DOWN"), JXDatePicker.NEXTMONTH_NAVIGATE_KEY);
        inputMap.put(KeyStroke.getKeyStroke("PAGE_UP"), JXDatePicker.PREMONTH_NAVIGATE_KEY);
    }
    ...
    protected void uninstallLinkPanelKeyboardActions(JComponent panel) {
        ...
        map.remove(JXDatePicker.FIRSTDATE_NAVIGATE_KEY); 
        map.remove(JXDatePicker.ENDDATE_NAVIGATE_KEY); 
        map.remove(JXDatePicker.NEXTMONTH_NAVIGATE_KEY); 
        map.remove(JXDatePicker.PREMONTH_NAVIGATE_KEY); 
        InputMap inputMap = panel.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW);
        // PENDING: get from LF
        inputMap.remove(KeyStroke.getKeyStroke("shift INSERT"));
        inputMap.remove(KeyStroke.getKeyStroke("INSERT"));
        inputMap.remove(KeyStroke.getKeyStroke("HOME"));
        inputMap.remove(KeyStroke.getKeyStroke("END"));
...
//  --------------------- wiring listeners    
    ...
    protected JFormattedTextField createEditor() {
        JFormattedTextField f = new DefaultEditor(getDateFormatter("yyyy/MM/dd(E)"));
        f.setName("dateField");
...
//        }
	 ...
	 * @return
	 */
	private DefaultFormatter getDateFormatter(String pattern) {
    ...
    private class DefaultEditor extends JFormattedTextField implements UIResource {
        ...
        public DefaultEditor(DefaultFormatter formatter) {
            super(formatter);
        }
...
//------------------- methods called by installed actions
    ...
    protected void home(boolean commit) {
    	Date today = new Date();
        if (commit) {
            datePicker.getMonthView().setSelectionDate(today);
    ...
    protected void nextMonth() {
    	Date netxMonthDate = DateUtils.getNextMonth(datePicker.getMonthView().getSelectionDate());
    	datePicker.getMonthView().ensureDateVisible(netxMonthDate);
        datePicker.getMonthView().setSelectionDate(netxMonthDate);
    }
    
    protected void preMonth() {
    	Date preMonthDate = DateUtils.getPrevMonth(datePicker.getMonthView().getSelectionDate());
    	datePicker.getMonthView().ensureDateVisible(preMonthDate);
        datePicker.getMonthView().setSelectionDate(preMonthDate);
    }
    
    protected void firstDate() {
    	Date date = DateUtils.getFirstDayOfWeek(datePicker.getMonthView().getSelectionDate());
    	datePicker.getMonthView().ensureDateVisible(date);
    	datePicker.getMonthView().setSelectionDate(date);
    }
    
    protected void endDate() {
    	Date date = DateUtils.getLastDayOfWeek(datePicker.getMonthView().getSelectionDate());
    	datePicker.getMonthView().ensureDateVisible(date);
    	datePicker.getMonthView().setSelectionDate(date);
    }
...
//---------------------- other stuff    
    ...
    private Action createNextMonthAction() {
    	Action action = new AbstractAction( ) {
    ...
    private Action createFirstDateAction() {
    	Action action = new AbstractAction( ) {
    ...
    private Action createEndDateAction() {
    	Action action = new AbstractAction( ) {
    ...
    private Action createPreMonthAction() {
    	Action action = new AbstractAction( ) {
...
//            datePicker.requestFocusInWindow();
            SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    ...
                    // not show Date when click button date popup
//                    if (datePicker.getMonthView().getSelectionDate() == null){
//                    	datePicker.getMonthView().setSelectionDate(new Date());
//                    	datePicker.getMonthView().ensureDateVisible(new Date());
//                    }
                }
            });
        }
