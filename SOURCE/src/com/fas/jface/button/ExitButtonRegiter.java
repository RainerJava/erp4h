 ...
 *
 */
public class ExitButtonRegiter extends ActionButton {
	 ...
	 * @param name
	 */
	public ExitButtonRegiter(String name){
	    super(name);
	    initData();
	}
	 ...
	 * @param frame
	 */
	public ExitButtonRegiter(JFrame frame){
	    this();
	    this.frame = frame;
	}
        	...
        	if (isConfirmRerquired == true) {
	        	...
	        	if (flg) {
		            if (frame != null) {
		            	...
		            	ApplicationUtils.logData(ApplicationConstants.loginUser.getUserId(), "100", "120", "CL", "");
		            	frame.dispose();
		            	frame = null;
		            	if (parentFrame != null) {
