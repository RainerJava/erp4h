...
public abstract class AbstractTextArea extends ImeTextArea implements FocusListener {
     ...
     * @param name
     */
    public AbstractTextArea(String name){
        this(name,20,0,0);
        init();
    }
     ...
     * @param columns
     */
    public AbstractTextArea(String name,int columns){
     ...
     * @param maxlength
     */
    public AbstractTextArea(String name,int columns,int mode,int maxlength){
        super(columns, mode);
    ...
    class InputControllDocument extends DefaultStyledDocument {
	     ...
	     * @param initParent
	     */
	    public InputControllDocument(AbstractTextArea initParent){
	        super();
	        parent = initParent;
	    }
