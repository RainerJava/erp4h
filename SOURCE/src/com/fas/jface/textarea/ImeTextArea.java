...
public class ImeTextArea extends JTextArea implements Validation {
    ...
    public ImeTextArea(String name,int maxlength){
		//super(maxlength);
		setName(name);
        init();
	}
    
    public ImeTextArea(String name){
        this(name,20);
    }
     ...
     * @param type
     */
    public ImeTextArea(int columns,int type){
        //super(columns);
        setIMType(type);
        init();
    }
    ...
    class InputControllDocument extends DefaultStyledDocument {
         ...
         * @param initParent
         */
        public InputControllDocument(ImeTextArea initParent){
            super();
            parent = initParent;
        }
