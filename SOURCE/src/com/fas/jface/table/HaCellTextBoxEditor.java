 ...
 *     プロジェクト名	：エスイーシー化成
 * 
 *     ファイル名		：HaCellTextBoxEditor.java
 *
 *     記述				：
 *     
 *     作成日			：2010/07/09   
...
public class HaCellTextBoxEditor extends DefaultCellEditor implements TableCellEditor {

	/** */
	private static final long serialVersionUID = 1L;

	/** */
	private BaseInputText txtInput;

	/** */
	private InspectTable m_table;

	public HaCellTextBoxEditor(BaseInputText txtInput, InspectTable table) {
		super(txtInput);
	...
	public void setUpperCaseLetters(boolean upperCase){
		txtInput.setUpperCaseLetters(upperCase);
	}
