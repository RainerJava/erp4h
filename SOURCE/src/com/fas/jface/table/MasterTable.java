...
public class MasterTable extends JTable {
	...
	/** */
	protected MasterTableHeaderRenderer calHeaderRender = new MasterTableHeaderRenderer();
	 ...
	 * @param col
	 */
	public MasterTable(int row,int col){
	 ...
	 * @param model
	 */
	public MasterTable(TableModel model){
		super(model);
	...
	void init(){
		...
		setDefaultRenderer(GenericCellRenderer.class, genericRenderer);
	 ...
	 *
	 */
	protected class MasterTableHeaderRenderer extends JLabel implements TableCellRenderer {
		
		  /** */
		private static final long serialVersionUID = 1L;

		public MasterTableHeaderRenderer() {
