 ...
 * 
 */
public abstract class BaseMasterLayoutFrame extends MasterFrame {
	 ...
	 * </DL>
	 */
	public BaseMasterLayoutFrame(BaseFrame frame, String title) {
		super(title);
		parentFrame = frame;
		init();
	}
	
	public BaseMasterLayoutFrame(BaseFrame frame, String title, boolean tblButtonDisplay) {
		super(title);
		parentFrame = frame;
	...
	public BaseMasterLayoutFrame(BaseFrame frame, boolean tblButtonDisplay) {
		super(frame);
		parentFrame = frame;
		displayTableButton = tblButtonDisplay;
		init();
	 ...
	 * </DL>
	 */
	public BaseMasterLayoutFrame(BaseFrame frame) {
		super(frame);
		parentFrame = frame;
		init();
	}
...
//	}
	...
	protected BasePanel getFooter() {
		...
		if (enbaleB[2]) {
			...
			btnF2.setToolTipText("[F2]：複写モードに変更します。");
