 ...
 *     プロジェクト名	：
 * 
 *     ファイル名		：BaseMasterDetailFrame.java
 *
 *     記述				：
 *     
 *     作成日			：2010/02/15
...
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F10Action;
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F11Action;
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F1Action;
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F2Action;
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F3Action;
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F4Action;
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F5Action;
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F6Action;
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F7Action;
import com.fas.jface.bussiness.BaseMasterFrameLayoutNEW.F8Action;
 ...
 * 
 */
public abstract class BaseMasterLayoutFrameForOrderProcessing extends MasterFrame {

	/** */
	private static final long serialVersionUID = 1L;
	/** */
	static Logger logger = Logger.getLogger(BaseMasterLayoutFrameForOrderProcessing.class);
	/** */
	 ...
	 * </DL>
	 */
	public BaseMasterLayoutFrameForOrderProcessing(BaseFrame frame, String title) {
		super(title);
		parentFrame = frame;
		init();
	}
	
	public BaseMasterLayoutFrameForOrderProcessing(BaseFrame frame, String title, boolean tblButtonDisplay) {
		super(title);
		parentFrame = frame;
	...
	public BaseMasterLayoutFrameForOrderProcessing(BaseFrame frame, boolean tblButtonDisplay) {
		super(frame);
		parentFrame = frame;
		displayTableButton = tblButtonDisplay;
		init();
	 ...
	 * </DL>
	 */
	public BaseMasterLayoutFrameForOrderProcessing(BaseFrame frame) {
		super(frame);
		parentFrame = frame;
		init();
	}
	 ...
	 * </DL>
	 */
	public BaseMasterLayoutFrameForOrderProcessing() {
		super();
		init();
	}
	// Call for exit form
...
//			sms
//					.setText("<html><center><b><font size=+1>只今処理中です。</font></b></center><center><b><font size=+1>しばらくお待ち下さい。</font></b></center>");
//			sms.setHorizontalAlignment(SwingConstants.CENTER);
//			content.add(sms, BorderLayout.CENTER);
//		}
//	}
