...
public abstract class ChartFactory {
    ...
    public static JFreeChart createPieChart(String title, PieDataset dataset,
        ...
        JFreeChart chart = new JFreeChart(title, FontConstants.GRAPH_TITLE_FONT,
                plot, legend);
    ...
    public static JFreeChart createPieChart(String title, PieDataset dataset,
        ...
        JFreeChart chart =  new JFreeChart(title,
                FontConstants.GRAPH_TITLE_FONT, plot, legend);
    ...
    public static JFreeChart createPolarChart(String title,
        ...
        JFreeChart chart = new JFreeChart(
                title, FontConstants.GRAPH_TITLE_FONT, plot, legend);
        currentTheme.apply(chart);
        return chart;
