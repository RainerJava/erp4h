...
public class MCtlFrameEdit extends InspectDialog {
	...
	/** */
	// private BaseInputText txtCData;
	// private INumberText txtCData;
	 ...
	 * </DL>
	 */
	public MCtlFrameEdit(BaseFrame owner, boolean modal) {
		super(owner, modal);
		init();
	}
	 ...
	 *            </DL>
	 */
	public MCtlFrameEdit(BaseFrame owner, boolean modal, String strUserid, String strCKey, boolean bPermission) {
		super(owner, modal);
	...
	private boolean validateData() {
		...
		if (strCAttr.equals("文字"))// Is varchar
		{
			...
			System.out.println("iMAxLength : ===========> " + iMaxLength);
