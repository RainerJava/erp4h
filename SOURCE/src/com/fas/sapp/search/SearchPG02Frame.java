 ...
 * @description
 */
public class SearchPG02Frame extends SearchTransactionFrame {
	 ...
	 * </DL>
	 */
	public SearchPG02Frame(BaseFrame frame) {
		super(frame, true);
        init();
	}
	 ...
	 * @param title
	 */
	public SearchPG02Frame(BaseFrame frame, String title) {
        super(frame, true);
        setTitle(title);
        init();
	}
	 ...
	 * @param modal
	 */
	public SearchPG02Frame(BaseFrame frame, boolean modal) {
        super(frame, modal);
        init();
	}
	 ...
	 * </DL>
	 */
	public SearchPG02Frame(BaseFrame frame,SortObjVo sortVo) {
	...
	protected TrSchdspVo getSchDspVo() {
		...
		dspVo.setDspCode(StringUtils.convertIntegerToStr(SearchTransactionFrame.I_PG02_SEARCH));			
		dspVo.setDspName("住所検索");			
		dspVo.setSchCtl("SCH_PG02");
		dspVo.setTblName("PG02");
		
		// SQL_ID: SQLID get from XML
		dspVo.setSqlId("PG02001");			
		...
		dspVo.setSpdColnm2("住所名");
		dspVo.setSpdColnm3("カナ");
		dspVo.setSpdColnm4("");
		dspVo.setSpdColnm5("");
		dspVo.setSpdColnm6("");
		dspVo.setSpdColnm7("");
	...
	protected void initPnlCondition(BasePanel pnlFilter) {
		...
		lblLine1Label1.setVisible((dspVo.getCmbItem1().equals("0"))?true:false);
		...
		lstData = comService.getLstG0103OfPG01(true);
		...
		cbbLine1Combo2.setVisible((dspVo.getCmbItem1().equals("0"))?true:false);
		...
		lblLine2Label1.setVisible((dspVo.getTxtItem1().equals("0"))?true:false);
		...
		txtLine2Text2.setVisible((dspVo.getTxtItem1().equals("0"))?true:false);
...
//		m_table.getTableHeader().setPreferredSize(new Dimension(m_table.getTableHeader().getWidth(),FaceContants.TABLE_HEADER_HEIGHT));
	...
	public static void main(String args[]) {
		//Use for testing
		SearchPG02Frame templte = new SearchPG02Frame();
		templte.pack();
