...
import com.fas.jface.table.ColumnGroup;
import com.fas.jface.table.GenericCellRenderer;
import com.fas.jface.table.GroupableTableHeader;
 ...
 * @description
 */
public class SearchPE01Frame extends SearchTransactionFrame {
	 ...
	 * </DL>
	 */
	public SearchPE01Frame(BaseFrame frame) {
		super(frame, true);
        init();
	}
	 ...
	 * @param title
	 */
	public SearchPE01Frame(BaseFrame frame, String title) {
        super(frame, true);
        setTitle(title);
        init();
	}
	 ...
	 * @param modal
	 */
	public SearchPE01Frame(BaseFrame frame, boolean modal) {
        super(frame, modal);
        init();
	}
	 ...
	 * </DL>
	 */
	public SearchPE01Frame(BaseFrame frame,SortObjVo sortVo) {
...
//		}
	...
	private void createTable()
	{
		...
		int[] align = { BaseLabel.LEFT, BaseLabel.LEFT, BaseLabel.RIGHT, BaseLabel.RIGHT, BaseLabel.RIGHT, BaseLabel.RIGHT};
		InspectTableRenderer renderer = new InspectTableRenderer(align);
		m_table.setSearchRenderer(renderer);
		//e: SET TABLE ALIGN

		//b: SET TABLE HEADER
		TableColumnModel tblColumnModel = m_table.getColumnModel();
		// group 
		ColumnGroup group1 = new ColumnGroup(" ");
		group1.add(tblColumnModel.getColumn(0));
		// group 
		ColumnGroup group2 = new ColumnGroup(" ");
		group2.add(tblColumnModel.getColumn(1));
		// group 売上単価
		ColumnGroup group3 = new ColumnGroup("売上単価");
		group3.add(tblColumnModel.getColumn(2));
		group3.add(tblColumnModel.getColumn(3));		
		// group 当月最終仕入り単価
		ColumnGroup group4 = new ColumnGroup("当月最終仕入り単価");
		group4.add(tblColumnModel.getColumn(4));
		group4.add(tblColumnModel.getColumn(5));
		
		// set groups as headers
		GroupableTableHeader header = new GroupableTableHeader(m_table.getColumnModel());
        ...
        header.setBackground(ColorConstants.TABLE_HEADER_BACKGROUND_COLOR);
		header.setBorder(new EtchedBorder(EtchedBorder.LOWERED));
		m_table.setTableHeader(header);
	    //e: SET TABLE HEADER
...
//		m_table.getTableHeader().setPreferredSize(new Dimension(m_table.getTableHeader().getWidth(),FaceContants.TABLE_HEADER_HEIGHT));
	...
	public static void main(String args[]) {
		//Use for testing
		SearchPE01Frame templte = new SearchPE01Frame();
		templte.pack();
