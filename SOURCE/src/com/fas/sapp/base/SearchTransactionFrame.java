 ...
 * 
 */
public abstract class SearchTransactionFrame extends InspectDialog {
	...
	/** */
	public static final int I_PC01_SEARCH = 7;
	/** */
	public static final int I_PG01_SEARCH = 8;
	/** */
	public static final int I_PG02_SEARCH = 9;
	 ...
	 * </DL>
	 */
	public SearchTransactionFrame(BaseFrame owner, boolean modal) {
		super(owner, modal);
		init();
	}
	 ...
	 *            </DL>
	 */
	public SearchTransactionFrame(BaseFrame owner, SortObjVo sortObj, boolean modal) {
		super(owner, modal);
	...
	protected abstract SearchTableTransaction getMTable();
	
	protected abstract SearchTableTransaction getMTable(SortObjVo sortObj);
