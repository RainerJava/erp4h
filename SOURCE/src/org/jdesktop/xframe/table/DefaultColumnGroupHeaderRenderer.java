...
public class DefaultColumnGroupHeaderRenderer extends DefaultTableCellRenderer implements ColumnGroupHeaderRenderer {
    ...
    public final Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected,
        ...
        if(stValue.equalsIgnoreCase("順")||
           stValue.equalsIgnoreCase("加工名")	||
           stValue.equalsIgnoreCase("加工")	||
           stValue.equalsIgnoreCase("大分類")	||
           stValue.equalsIgnoreCase("中分類")	||
           stValue.equalsIgnoreCase("部材")	||
           stValue.equalsIgnoreCase("内")	||
           stValue.equalsIgnoreCase("外")	||
           stValue.equalsIgnoreCase("引代")	||
           stValue.equalsIgnoreCase("計算値")	||
           stValue.equalsIgnoreCase("マーキン")){;          
