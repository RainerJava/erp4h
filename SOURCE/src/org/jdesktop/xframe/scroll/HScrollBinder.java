 ...
 * <code>getHorizonzalScrollbar()</code> method that returns a
 * <code>JScrollBar</code> object.</p>
 *
 * @author <a href=mailto:kriede@users.sourceforge.net>Kurt Riede</a>
 */
public final class HScrollBinder extends AbstractScrollBinder {

    /**
     * Contructor.
     */
    public HScrollBinder() {
        super();
    }
     ...
     * <code>getHorizontalScrollBar()</code>.</p>
     *
    ...
    public void add(final JComponent component) {
        add(component, "getHorizontalScrollBar");
    }
    ...
    public void remove(final JComponent component) {
        remove(component, "getHorizontalScrollBar");
    }
}
