...
/**
 * MExectl1 generated by hbm2java
 */
@Entity
@Table(name = "M_EXECTL1", schema = "DB2ADMIN")
public class MExectl1 implements java.io.Serializable {

	private MExectl1Id id;
	...
	public MExectl1(MExectl1Id id) {
		this.id = id;
	}

	public MExectl1(MExectl1Id id, Character controlType, String addUser,
	...
	public MExectl1Id getId() {
		return this.id;
	}

	public void setId(MExectl1Id id) {
		this.id = id;
	}
