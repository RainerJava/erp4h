...
/**
 * MMenuexeId generated by hbm2java
 */
@Embeddable
public class MMenuexeId implements java.io.Serializable {
	...
	public MMenuexeId(String menugrpCode, String menuexeCode) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MMenuexeId))
			return false;
		MMenuexeId castOther = (MMenuexeId) other;
