...
public class DatePicker extends JXDatePicker {
	...
	public DatePicker() {
		...
		thu = new String[] { "thu 2", "thu 3", "thu 4", "thu 5",
		...
		setLinkDay(SystemParameters.CURRENT_PC_TIME, "Hom nay: "
				+ getDayOfWeek()+" ngay "+dayFormat.format(SystemParameters.CURRENT_PC_TIME));
		
	}
	private String getDayOfWeek(){
		String strDayOfWeek=null;
		getMonthView().getCalendar();
