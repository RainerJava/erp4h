...
public class DepartmentBLL {
	...
	public void Delete(KhoaPhongDTO DTO_KhoaPhong) throws Exception {
		this.connect.Delete("tblKhoaPhong",
				"KhoaPhongID" + DTO_KhoaPhong.getKhoaPhongID());
	}

	public KhoaPhongDTO getByID(int id) throws Exception {
		HashSet<KhoaPhongDTO> HS_KhoaPhong = this.getKhoaPhong("KhoaPhongID="
				+ id);
	...
	public HashSet<KhoaPhongDTO> getKhoaPhong(String Condition)
			throws Exception {
		return getKhoaPhong(Condition, null);
	}

	public HashSet<KhoaPhongDTO> getKhoaPhong(String Condition, String OrderBy)
			throws Exception {
	...
	public void Update(KhoaPhongDTO DTO_KhoaPhong) throws Exception {
		...
		map.put("KhoaPhongID", DTO_KhoaPhong.getKhoaPhongID());
		map.put("TenKhoaPhong", DTO_KhoaPhong.getTenKhoaPhong());
		this.connect.Update("tblKhoaPhong", map,
				"KhoaPhongID" + DTO_KhoaPhong.getKhoaPhongID());
	}

	public ArrayList<KhoaPhongDTO> getArrKhoaPhong() throws Exception {
		return getArrKhoaPhong(null);
	}

	public ArrayList<KhoaPhongDTO> getArrKhoaPhong(String Condition)
			throws Exception {
		return getArrKhoaPhong(Condition, null);
	}

	public ArrayList<KhoaPhongDTO> getArrKhoaPhong(String Condition,
			String OrderBy) throws Exception {
		ResultSet rs = this.connect.Select("tblKhoaPhong", Condition, OrderBy);
		ArrayList<KhoaPhongDTO> arrKhoaPhong = new ArrayList<KhoaPhongDTO>();
		while (rs.next()) {
			KhoaPhongDTO dtoKhoaPhong = new KhoaPhongDTO();
			dtoKhoaPhong.setKhoaPhongID(rs.getInt("KhoaPhongID"));
			dtoKhoaPhong.setTenKhoaPhong(rs.getString("TenKhoaPhong"));
			arrKhoaPhong.add(dtoKhoaPhong);
		}
		return arrKhoaPhong;
	}
}