...
public class UserBLL {
	...
	// trả v�? tổng số cột (field) của truy vấn rs
	...
	public ArrayList<Integer> getUserRight(ArrayList<Object> parameter)
			throws Exception {
		ResultSet rs = connect.prepareCall("spUser_SelectUserRight", parameter);
		ArrayList<Integer> arr = new ArrayList<Integer>();

		while (rs.next()) {
			ArrayList<Integer> s = new StringUtil().getIntArray(rs
					.getString("GroupRight"));
	...
	public ArrayList<PhanHeDTO> getArrModuleByUserID(String UserID) throws Exception {
		ArrayList<Object> arrObj=new ArrayList<Object>();
		arrObj.add(UserID);
		
		ArrayList<PhanHeDTO>arrPhanHe=new ArrayList<PhanHeDTO>();
		ResultSet rs=this.connect.prepareCall("spModul_SelectModulByUserID", arrObj);
		while(rs.next()){
